...
Eigen::Vector3d Plane2d::GetDesiredCrosstrackLocation(Eigen::Vector3d current_cartesian_position, double &distance_param_x, double &distance_param_y)
{
...
Eigen::Matrix3d Plane2d::GetPlaneUnitDirection()
{
