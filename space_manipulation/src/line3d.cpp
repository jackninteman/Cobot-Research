...
// This function calculates the desired cross track location based on the defined line and the current Cartesian end effector position
...
{
    if (time_in_sec > time_final_in_sec)
        time_in_sec = time_final_in_sec;
