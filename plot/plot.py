...
bag = rosbag.Bag('/home/rsl/catkin_ws/cobot_data/continuous_circle.bag')
...
plt.title('X Position Trajectory Control (error limit = 20mm, continuous circular movement)')
...
plt.title('Y Position Trajectory Control (error limit = 20mm, continuous circular movement)')
plt.legend(loc='best', fontsize='x-small')
plt.xlabel('Time (seconds)')
plt.ylabel('Position (meters)')
...
plt.title('Z Position Trajectory Control (error limit = 20mm, continuous circular movement)')
plt.legend(loc='best', fontsize='x-small')
plt.xlabel('Time (seconds)')
plt.ylabel('Position (meters)')
